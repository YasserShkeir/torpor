...
saved you some memory, every way to chip in lives on one page:

**[yasser-shkeir.com/donate](https://www.yasser-shkeir.com/donate)** — card
tiers through Stripe, one-time or monthly, plus
[GitHub Sponsors](https://github.com/sponsors/YasserShkeir), which takes no fee.

The **Support** button in the popover footer opens the same page.
